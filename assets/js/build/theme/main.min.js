...
"use strict";!function(n){var i=jQuery("body"),t=i.find(".navigation-top");t.find(".wrap"),t.find(".menu-item"),t.find(".menu-toggle"),i.find(".entry-content"),i.hasClass("dshedd-front-page")||i.hasClass("home blog");hljs.initHighlightingOnLoad()}();